    ...
    <div class="container-fluid">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-control">
                <button type="button" class="btn btn-primary fa fa-arrow-right" data-bs-toggle="modal" data-bs-target="#bagModal">
        ...
        <table id="postsTable" class="table table-striped">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Bag Type</th>
                    <th>Formula No. Of Bag Per Roll (Length)</th>
                    <th>Formula No. Of Bag Per Roll (Weight)</th>
                    <th>Action</th>
                </tr>
            </thead>
            <tbody>
    ...
    $(document).ready(function(){
        $('#postsTable').DataTable({
            ...
            columns: [{
                ...
                {
                    data: "formula_to_bag_by_length",
                    name: "formula_to_bag_by_length"
                },
                {
                    data: "formula_to_bag_by_weight",
                    name: "formula_to_bag_by_weight"
                },
                {
                    data: "action",
                    name: "action",
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status==true) {
                    ...
                    $("#formulaToBagByLength").val(bagDtl?.formula_to_bag_by_length);
                    $("#formulaToBagByWeight").val(bagDtl?.formula_to_bag_by_weight);
                    $("#bagModal").modal("show");
