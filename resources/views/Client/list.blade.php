    ...
    <div class="container-fluid">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-control">
                <button type="button" class="btn btn-primary fa fa-arrow-right" data-bs-toggle="modal" data-bs-target="#clientModal">
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status==true) {
                    ...
                    $("#clientEmail").val(clientDtl?.client_email);
                    $("#clientMobileNo").val(clientDtl?.client_mobile_no);
                    $("#clientAddress").val(clientDtl?.client_address);
