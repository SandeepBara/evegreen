        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status==true) {
                    ...
                    $("#vendorEmail").val(vendorDtl?.vendor_email);
                    $("#vendorMobileNo").val(vendorDtl?.vendor_mobile_no);
                    $("#vendorGstNo").val(vendorDtl?.vendor_gst_no);
                    $("#vendorAddress").val(vendorDtl?.vendor_address);
