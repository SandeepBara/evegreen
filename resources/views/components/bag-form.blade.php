        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="bagForm">
                    ...
                    <!-- Client Email -->
                    <div class="mb-3">
                        <label class="form-label" for="formulaToBagByLength">Formula To Bag By Length<span class="text-danger">*</span></label>
                        <textarea id="formulaToBagByLength" name="formulaToBagByLength" class="form-control" placeholder="" required></textarea>

                    </div>

                    <div class="mb-3">
                        <label class="control-label" for="formulaToBagByWeight">Formula No. Of Bag Per Roll (Weight)<span class="text-danger">*</span></label>
                        <textarea id="formulaToBagByWeight" name="formulaToBagByWeight" class="form-control" placeholder="" required></textarea>
                    </div>
